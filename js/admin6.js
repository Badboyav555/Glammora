...
async function loadOrders() {
    ...
    orders.forEach(function(o) {
        ...
        html += '<tr>';
        html += '<td><strong>#' + String(o.id).slice(-6) + '</strong><br><small>' + new Date(o.created_at).toLocaleDateString('en-IN') + '</small></td>';
        html += '<td>' + fullAddr + '</td>';
    ...
    document.getElementById('ordersTable').innerHTML = html || '<tr><td colspan="6" style="text-align:center;padding:30px;">No orders found</td></tr>';
}
